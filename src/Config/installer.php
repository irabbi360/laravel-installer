...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | using artisan command generate storage link
    |
    */
    'generate_storage_link' => true,

    /*
    |--------------------------------------------------------------------------
    | File Move
    |--------------------------------------------------------------------------
    | enable file move is true a file is move from source to destination
    |
    */
    'enable_file_move' => false,
    'source_file' => base_path('storage/devstarit.php'),
    'destination_path' => config_path('devstarit.php'),
];
