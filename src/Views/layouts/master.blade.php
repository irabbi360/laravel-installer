...
<div class="master">
    <div class="box">
        ...
        <ul class="step">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{ isActive('LaravelInstaller::adminSetup') }}">
                @if(Request::is('install/admin-setup'))
                    <a href="{{ route('LaravelInstaller::adminSetup') }}">
            ...
            <li class="step__item {{ isActive('LaravelInstaller::permissions') }}">
                @if(Request::is('install/admin-setup') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
            ...
            <li class="step__item {{ isActive('LaravelInstaller::requirements') }}">
                @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/admin-setup') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
