...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'Irabbi360\LaravelInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
    ...
    Route::get('admin-setup', [
        'as' => 'adminSetup',
        'uses' => 'UserController@adminSetup',
    ]);

    Route::post('admin-setup/adminSaveWizard', [
        'as' => 'adminSaveWizard',
        'uses' => 'UserController@adminSaveWizard',
    ]);
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Irabbi360\LaravelInstaller\Controllers', 'middleware' => 'web'], function () {
